...
#INPUT="/data/ailiena/AM_Drive_6/data/190326/297/A2_15000/Av1_297A2_15000_output_P21.sca"
...
$CCP4/ctruncate -hklin $OUTPUT_HKL -hklout $OUTPUT_TRUNCATE -colin "/*/*/[IMEAN,SIGIMEAN]" -colano "/*/*/[I(+),SIGI(+),I(-),SIGI(-)]" <<+ >>$LOGFILE
+
...
mv $OUTPUT_MTZ $NAME_MTZ.mtz
NAME_MTZ_LOG=`echo "$FILENAME" | cut -d'.' -f1`
mv $LOGFILE "$WDIR"/log/"$NAME_MTZ_LOG"_sca2mtz.log
